...
namespace PackageExplorerViewModel.Rules
{
    ...
    internal class NonAssemblyInsideLibRule : IPackageRule
    {
        ...
        {
            IEnumerable<string> allLibFiles = package.GetFilesInFolder("lib");
            var assembliesSet = new HashSet<string>(allLibFiles.Where(FileHelper.IsAssembly),
        ...
        private static PackageIssue CreatePackageIssue(string target)
        {
            return new PackageIssue(
                ...
                "The file '" + target +
                "' is not a valid assembly. If it is a XML documentation file or a .pdb file, there is no matching assembly specified in the same folder.",
