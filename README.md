...
| Build Number | Link |
| ------------ | ---- |
| [![Nightly build number](https://nugetpackageexplorer.blob.core.windows.net/nightly/version_badge.svg?v=1)](ms-appinstaller:?source=https://nugetpackageexplorer.blob.core.windows.net/nightly/PackageExplorer.Package.Nightly.appinstaller)| [Install](ms-appinstaller:?source=https://nugetpackageexplorer.blob.core.windows.net/nightly/PackageExplorer.Package.Nightly.appinstaller)
